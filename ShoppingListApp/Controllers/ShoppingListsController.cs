...
namespace ShoppingListApp.Controllers
{
    public class ShoppingListsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Username,Password,Items")] ShoppingList shoppingList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Username,Password,Items")] ShoppingList shoppingList)
        {
            if (ModelState.IsValid)
            {
